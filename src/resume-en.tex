...
\begin{document}
    ...
    \section{Tech Skills}
    \cvdoubleitem{Languages}{Python, Go, TypeScript, C/C++, Java}{Cloud}{AWS, Docker, Kubernetes, Helmcharts, ArgoCD, Traefik, Terraform, Packer}
    ...
    \cventry{09.2023 -- 31.10.2024}{Software Developer}{Snom Gmbh}{Berlin}{ Germany }{
      ...
      Deployment was performed using ansible roles (which started docker containers on remote VMs).
      Deployment was triggered via Jenkins jobs. Application's authentication was based on company's internal LDAP.
      Our team was responsible for infrastructure as well (i.e. we managed Proxmox and VMs in it).
      }
