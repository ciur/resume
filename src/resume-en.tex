...
\begin{document}
    ...
    \section{Tech Skills}
    \cvdoubleitem{Languages}{Python, TypeScript/JavaScript, C/C++}{Cloud}{AWS, Docker, Kubernetes, Helmcharts, ArgoCD}
    ...
    \cvdoubleitem{Message Queues}{RabbitMQ, Redis}{Protocols}{TCP/IP, HTTP, IMAP, POP3}
