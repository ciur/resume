...
\begin{document}
    ...
    I am Sr. Software Engineer with more then 15 years of
    ...
    \section{Tech Skills}
    \cvdoubleitem{Languages}{Python, TypeScript, JavaScript, SQL}{Cloud}{AWS, Docker, Kubernetes, Helmcharts, ArgoCD, Traefik, Terraform, Packer}
    \cvdoubleitem{Web Frameworks}{Django, Flask, FastAPI, DRF, React, Redux, pytest}{CVS}{git, mercurial, github, gitlab}
    \cvdoubleitem{Databases}{PostgreSQL, Mysql/MariaDB, SQLite}{Other}{REST API, OpenAPI, swagger, CI/CD, websockets}
    \cvdoubleitem{Open Source Packages}{SQLAlchemy, Redux, React, pytest, pydantic}{Search Engines}{SOLR, Elasticsearch}
    \cvdoubleitem{Message Queues}{RabbitMQ, Redis, Celery, RQ}{Protocols}{TCP/IP, HTTP, IMAP, POP3, SMTP}
    ...
    \cventry{09.2023 -- 31.10.2024}{Software Developer}{Snom Gmbh}{Berlin}{ Germany }{
      ...
      Deployment was performed using ansible roles}

    \cventry{11.2022 -- 09.2023}{Team Lead}{IONOS Cloud}{Berlin}{ Germany }{
      In my team lead role I managed a small team of four persons
        which consisted of two developers, one QA engineer and me.
        We used SCRUM as base framework for organizing our
        development process. Our team was responsible for maintaining
   ...
   \vspace{0.4cm}
    ...
    \cventry{05.2021 -- 11.2022}{Sr. Python Developer}{IONOS Cloud}{Berlin}{ Germany }{
      In was in charge of development, maintenance and deployment of two internal applications - one Django based,
    ...
    \cventry{12.2019 -- present}{Open Source}{max. 4 hours/week}{Berlin}{ Germany }
    {
      Development and promotion of open source DMS for digital archives. Technically, Papermerge DMS is cloud native application - which means it designed to be deployed in k8s environments
    }
